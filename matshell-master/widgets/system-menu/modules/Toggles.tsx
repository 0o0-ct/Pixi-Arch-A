...
export const Toggles = (props: { showNotificationsOnly?: boolean; showTogglesOnly?: boolean } = {}) => {
  ...
  return (
    <box orientation={Gtk.Orientation.VERTICAL} visible={renderToggleBox}>
      ...
      {!props.showTogglesOnly && <NotificationBox forceExpanded={props.showNotificationsOnly} />}
    </box>
  );
};
