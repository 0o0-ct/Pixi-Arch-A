...
export const NotificationBox = (props: { forceExpanded?: boolean } = {}) => {
  ...
  const [isExpanded, setIsExpanded] = createState(props.forceExpanded ?? false);
  const revealChild = createComputed([isExpanded], (expanded) => props.forceExpanded || expanded);
  ...
  return (
    <box cssClasses={["toggle"]} orientation={Gtk.Orientation.VERTICAL}>
      ...
      <box>
        ...
        {props.forceExpanded ? (
          <box hexpand={true} cssClasses={["force-expanded-header"]}>
