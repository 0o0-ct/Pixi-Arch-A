...
notify_cmd_NOT="notify-send -u low -i ${iDoR}/nota.png "
...
countdown() {
	for sec in $(seq $1 -1 1); do
		notify-send -h string:x-canonical-private-synchronous:shot-notify -t 1000 -i "$iDIR"/timer.png  " Tomando captura" " en: $sec segs"
		sleep 1
	done
}
