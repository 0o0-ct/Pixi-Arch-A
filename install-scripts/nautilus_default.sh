...
LOG="Install-Logs/install-$(date +%d-%H%M%S)_nautilus-default.log"

printf "${INFO} Setting ${SKY_BLUE}Nautilus${RESET} as default file manager...\n"  
 
xdg-mime default org.gnome.Nautilus.desktop inode/directory
xdg-mime default org.gnome.Nautilus.desktop application/x-wayland-gnome-saved-search
echo "${OK} ${MAGENTA}Nautilus${RESET} ahora está configurado como el gestor de archivos predeterminado." | tee -a "$LOG"
