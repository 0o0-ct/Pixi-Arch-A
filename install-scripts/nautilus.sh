...
LOG="Install-Logs/install-$(date +%d-%H%M%S)_nautilus.log"

# Nautilus
printf "${INFO} Instalando ${SKY_BLUE}Nautilus${RESET} Packages...\n"  
  for PKG in "${nautilus_pkg[@]}"; do
