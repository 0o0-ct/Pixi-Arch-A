...
* **Cambiar Idioma de Teclado (Español / Inglés):** Presiona **`CTRL + SUPER + Espacio`** para alternar de forma instantánea la distribución de tu teclado. Por defecto, el sistema está configurado en **Español (`es`)** como idioma principal.
